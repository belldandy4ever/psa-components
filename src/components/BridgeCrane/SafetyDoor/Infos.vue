<template>
  <ul class="e-door-layer-infos-container" :style="containerStyle">
    <li 
    ...
    >
      <span class="e-door-no title">{{` ${index + 1}. ${cfg.name}`}}</span>
      <span class="e-door-name body-1">
        {{`${cfg.desc} ${cfg.dataIndex}`}}
      </span>
    </li>
  </ul>
</template>
